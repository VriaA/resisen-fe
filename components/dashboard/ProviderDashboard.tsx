  ...
  async function handleSubmit() {
    ...
    try {
      const payload: CreateProviderApplicationRequest = {
        ...
        ...(form.cacDocumentUrl.trim()
          ? { cacDocumentUrl: form.cacDocumentUrl.trim() }
          : {}),
      };
    ...
    <div className="fade-in-up max-w-lg mx-auto mt-10">
      <div className="text-center mb-6">
        ...
        <p className="text-body-regular text-body-dark">
          Submit your business details for review. Once approved, you&apos;ll be
          able to create and manage experiences.
        </p>
      </div>
...
export default function ProviderDashboard() {
  ...
  const [status, setStatus] = useState<
    "loading" | "error" | "noApplication" | "ready"
  >("loading");
